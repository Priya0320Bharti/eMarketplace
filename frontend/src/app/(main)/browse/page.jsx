...
const Browse = () => {
  ...
  return (
    <div>
      <>
        {/* Hero */}
        <div className="mt-7 sm:mt-12 rounded-full mx-auto max-w-xl relative">
          {/* Form */}
          <form>
                ...
                <div>
                  ...
                  >
                    <img
                      ...
                      className="h-full w-full object-contain-max object-center transition duration-200 group-hover:scale-110"
