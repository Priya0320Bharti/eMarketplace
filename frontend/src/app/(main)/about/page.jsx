    ...
    <div><div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-md px-4 md:px-8">
        ...
        <p className="mb-6 text-gray-500 sm:text-lg md:mb-8">
          Voice-controlled e-marketplaces have become an innovative and user-friendly way of conducting online shopping. The competitive advantages of integrating voice control into e-marketplaces are vast, as it offers enhanced convenience, accessibility, and improved customer experience.
          <br />
          <br />
          Voice commands allow users to browse products, add items to the cart, and complete purchases without needing to manually interact with a screen or keyboard. This hands-free shopping experience is especially useful in scenarios where users are multitasking (e.g., cooking, exercising, driving). By eliminating the need for typing or navigating complex menus, users can make quicker decisions and place orders faster, improving overall transaction speed.
          <a
            href="#"
      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          {/* text - end */}
          <div className="grid grid-cols-1 mx-16 gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
            {/* feature - start */}
