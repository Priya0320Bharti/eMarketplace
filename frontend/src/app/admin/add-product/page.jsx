...
const AddProduct = () => {
  ...
  return (
    <div className="min-h-screen bg-indigo-100">
      <div className="max-w-lg mx-auto container pt-7 pb-7">
        <div className="bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
