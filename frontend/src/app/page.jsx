          ...
          <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
            <header className="mb-8 border-b">
              <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
                ...
                {/* logo - end */}
                {/* nav - start */}
                <nav className="flex items-center gap-12 lg:flex 2xl:ml-16">
                  {/* start search */}
                  <form className="relative">
                    <div className="flex items-center gap-x-3 px-3 py-2 bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
                      <input
                        type="search"
                        onChange={searchProduct}
                        className="py-2.5 px-4 block w-full border-transparent rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 outline-none"
                        placeholder="Search product"
                        aria-label="Search products"
                      />
                      <button
                        type="submit"
                        className="inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 p-2"
                        aria-label="Search"
                      >
                        <svg
                  ...
                  <Link href="/about" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700">
                    About
                  </Link>
                  <Link href="/contact" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700">
                    Contact
                  </Link>
                  <Link href="/signup" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700">
                    Register
                  </Link>
                </nav>
                {/* nav - end */}
              ...
              <div className="mb-8 flex flex-wrap justify-between md:mb-16">
                <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
                  ...
                  <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
                    This is a section where we can browse, search, add to cart the items using voice command.
                    This website is totally based on voice command.
                  </p>
                </div>
            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
              ...
              <div className="mb-10 md:mb-16">
                ...
                <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
                  ...
                  to us to browse the items very easily. It shares some quality and quantity of the item
                  that would might be helped us  but is random or otherwise generated.
                </p>
              </div>
              {/* text - end */}
              ...
              <div className="flex flex-col overflow-hidden rounded-lg bg-gray-900 sm:flex-row md:h-80">
                ...
                <div className="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
                  ...
                  <p className="mb-8 max-w-md text-gray-400">
                    This is the section where all the summer sale is shown
                    so that costumer may access and buy the product very easily as well as
                    in large amount of discount.
                  </p>
              ...
              <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8 lg:flex-row lg:justify-between">
                <div className="mb-4 sm:mb-8 lg:mb-0">
                  ...
                  <p className="text-center text-gray-500 lg:text-left">
                    Sign up for our max discount of sale
                  </p>
                </div>
                <div className="flex flex-col items-center lg:items-end">
                  ...
                  <p className="text-center text-xs text-gray-400 lg:text-right">
                    By signing up to our sale you agree to our{" "}
                    <a
                      href="#"
              ...
              <div className="mb-16 grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
                <div className="col-span-full lg:col-span-2">
                  ...
                  <p className="mb-6 text-gray-500 sm:pr-8">
                    E- commerce is a powerful means to connect the unconnected to
                    global trade. Communication is the heart of e-commerce and community
                  </p>
                  {/* social - start */}
                  <div className="flex gap-4">
                    <a
